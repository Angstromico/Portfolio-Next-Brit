...
export default function Contact() {
  ...
  const t = {
    ...
    es: {
      title: 'Contáctame',
      description:
        'Si estás considerando mi contribución, tienes una pregunta o simplemente quieres saludar, ¡no dudes en ponerte en contacto conmigo!',
      hello: 'Saludar',
    },
  }[language]

  return (
    <section id='contact' className='scroll-mt-16 lg:mt-[17rem]'>
